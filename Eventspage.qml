...
Item {
    ...
    property alias eventModel: eventAlarmLog
    property var currentTableData: eventAlarmLog
    ...
    ColumnLayout {
        ...
        TabBar {
            ...
            TabButton {
                ...
                font.pointSize: 8
                onClicked: {
                    currentTableData = eventAlarmLog;
                }
            }
            TabButton {
                x: 176
                ...
                font.pointSize: 8
                onClicked: {
                    currentTableData = eventAlarmHistoryLog;
                }
            }
        }
                ...
                Repeater {
                    ...
                    Rectangle {
                        ...
                        RowLayout {
                            ...
                            Text {
                                text: model.priority
                                color: model.priority === "A" ? "red" : "blue"
                                font.bold: true
                                horizontalAlignment: Text.AlignRight
                            }
                        }
