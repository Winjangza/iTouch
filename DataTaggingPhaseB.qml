...
Item {
    ...
    Rectangle {
        ...
        TableView {
                    ...
                    Rectangle {
                        ...
                        MouseArea {
                            ...
                            onClicked: {
                                ...
                                console.log("checkBox ",checkBoxDelegate.isChecked ,newlistdatatebleB.list_number, newlistdatatebleB.list_number )
            ...
            onClicked: {
                console.log("TableView",newlistdatatebleB.get(row).num_list)
                setpropertyIDTable(newlistdatatebleB.get(row).num_list)
            }
        }
    }
    RowLayout {
        ...
        Button {
            ...
            onClicked: {
                ...
                var dataTagging = '{"objectName":"getDistanceDetailB","Distance": ' + distanceValue + ',"Detail": "' + detailValue + '", "PHASE": "B"}';
                console.log("getDistanceDetail:", dataTagging);
                qmlCommand(dataTagging);
                var updatetablePhaseB = '{"objectName":"UpdatePhaseB", "updatetablePhaseB": "dataPhaseB"}'
                qmlCommand(updatetablePhaseB);
            }
        }
        ...
        Button {
            text: "DELETE"
            onClicked: {
                console.log("Deleted:", checkedStates, newlistdatatebleB.num_list,num_list);
                if (checkedStates === true) {
                    // var numList = parseInt(newlistdatatebleB.num_list);
                    var numList = num_list;
                    var delectmySQL = '{"objectName":"delectmysqlB","checkedStates":'+checkedStates +',"num_list":'+num_list +'}';
